      ...
      <section className="rounded-2xl border border-foreground/10 bg-card p-6">
        ...
        <div className="mt-4 grid gap-4 md:grid-cols-2">
          ...
          <I
            ...
            v={draft.link_compra}
            on={(v) => setDraft({ ...draft, link_compra: v })}
          />
          ...
          <div>
            ...
            />
            {draft.portada_url ? (
              <img src={draft.portada_url} alt="" className="mt-2 h-24 w-auto rounded-lg" />
            ) : null}
          </div>
        </div>
            ...
            {list.map((b) => (
              <div key={b.id} className="rounded-2xl border border-foreground/10 bg-card p-4">
                <div className="flex gap-4">
                  {b.portada_url ? (
                    <img src={b.portada_url} alt="" className="h-24 w-16 rounded object-cover" />
                  ) : (
                    <div className="h-24 w-16 rounded bg-foreground/10" />
                  )}
                  ...
                  <button
                    onClick={() => remove(b.id)}
                    className="self-start rounded-full border border-destructive/40 p-1.5 text-destructive hover:bg-destructive hover:text-destructive-foreground"
                  >
